...
do
	...
	#bcftools consensus -f $refdir/library_${1}/library_${1}_cat.fasta $BWA/bcf.dir/${i:0:4}_clean_sort.mplilup.call.vcf.gz > $BWA/bcf.dir/${i:0:4}_call_consensus.fa
	#bcftools consensus -f $refdir/library_${1}/library_${1}_cat.fasta $BWA/bcf.dir/${i:0:4}_clean_sort.mplilup.call.filter.vcf.gz > $BWA/bcf.dir/${i:0:4}_call.filter.consensus.fa
done
	# "bcftools consensus"
