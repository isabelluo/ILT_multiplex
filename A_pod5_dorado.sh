...
do
    pod5files=`ls $current_directory/fast5/ | grep ".pod5" | wc -l`
    ...
    then
        ...
        then
            ...
            dorado basecaller dna_r9.4.1_e8_hac@v3.3 --min_qscore 7 --emit-fastq --device cuda:auto $current_directory/pod5/$i/. > $current_directory/fastq/$i/.
