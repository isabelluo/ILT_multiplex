...
do # I am trying to avoid changing working directories but I dont know how to do it
  ...
  porechop -i $current_directory/fastq/$i/pass/${i}_all.fastq -b $current_directory/fastq/$i/pass/${i}_chop_fastq \
  --check_reads 1000000 > $current_directory/fastq/$i/pass/${i}_porechopped_output.txt
